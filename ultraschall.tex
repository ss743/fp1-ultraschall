...
\gra{Versuchsaufbau}{Versuchsaufbau}
\section{Sinusgitter}
...
In Abbildung \ref{besselfits} wird nun die normierte Intensität über die Spannung aufgetragen. Anschließend werden quadrierte Besselfunktionen an die Datensätze gefittet. Tabelle \ref{besselfitdaten} zeigt die Parameter der gefitteten Funktionen.
