...
Für ein Gitter der  Breite L mit N Linien, der Spaltbreite b und der Gitterkonstane K ergibt sich die Aperturfunktion durch Wiederholung der Funktion eines Einzelspaltes \cite{staat}:
...
\gra{Sinusgitter}{Fraunhoferbeugungsmuster für ein dünnes Sinusgitter \label{Sinusgitter} \cite{2}}
...
\gra{Phasengitter}{Fraunhoferbeugungsmuster für ein Sinus - Phasengitter \label{Phasengitter} \cite{1}}
...
Wir haben für 5 verschiedenen unbekannte Amplitudengitter Interferenzmuster aufgenommen und bestimmen nun aus diesen die jeweilige Gitterkonstante. Die Zeitabhängigkeit der Interferenzmuster werden nun mithilfe des in \ref{Happyisttoll} berechneten Wertes in eine $\sin\theta$-Abhängigkeit umgerechnet. 

Durch Gaußfits an die im Beugungsmuster sichtbaren Maxima wird die Position und die Amplitude der Maxima bestimmt.

\graTwo[0.49]{amplitudengitter1a}{amplitudengitter1b}{Bestimmung der Maxima des ersten Amplitudengitters (Verschiedene Skalierungen, um alle Maxima gut erkennen zu können)}
\graTwo[0.49]{amplitudengitter2}{amplitudengitter3}{Bestimmung der Maxima des zweiten und des dritten Amplitudengitters}
\graTwo[0.49]{amplitudengitter4}{amplitudengitter5}{Bestimmung der Maxima des vierten und des fünften Amplitudengitters}

Anschließend wird aus den Beugungsordnungen in Abhängigkeit der Positionen der Maxima die Gitterkonstante des jeweiligen Gitters bestimmt. Die Steigung $a$ des linearen Fits $m=\frac{K}{\lambda}\sin\theta$ beträgt nun $a=\frac{K}{\lambda}$. Damit gilt für die Gitterkonstante: $$K=a\cdot\lambda$$
